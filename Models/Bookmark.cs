...
namespace reffffound.Models
{
	public class Bookmark
	{
		...
		public Bookmark(IFormCollection collection)
		{
			...
			var fullUrl =  "";
			if(collection.TryGetValue("FullUrl", out StringValues fullUrlValues))
			{
				fullUrl = fullUrlValues[0] ?? "";
			}
		...
		public void UpdateFrom(IFormCollection collection, bool isAdminEdit = false)
		{
			...
			var fullurl = collection["FullUrl"][0];
			...
			if (!string.IsNullOrEmpty( fullurl ) && !this.FullUrl.Equals( fullurl ))
			{
				FullUrl = fullurl;
			}
		...
		public bool IsValid(out string validationMessage)
		{
			...
			/* Full Url is optional */
			if (false && string.IsNullOrWhiteSpace( FullUrl ))
			{
				validationMessage = "Please provide an FullUrl to link your bookmark to.";
				isValid = false;
			}
		...
		public bool DataEquals(Bookmark bookmark)
		{
			...
			if (bookmark.FullUrl != this.FullUrl) return false;
